...
const qiangData = [
    ...
    { num: "蹚弟签", text: "上上签：龙腾虎跃展宏图，事业蒸蒸日上时。贵人相助添助力，前程似锦乐无涯。" },
    { num: "永杨哥签", text: "上上签：凤凰于飞在岐山，鸣声嘹亮动九天。夫妻和睦家兴旺，子孙满堂福绵绵。" },
    { num: "波哥签", text: "上上签：桃李满天下，春风得意时。功名成就非难事，富贵荣华在眼前。" },
    { num: "Penny签", text: "上上签：今日桃花运，宜约会，不宜动怒。" },
    { num: "Carry签", text: "上上签：今日福禄双至，宜出行，不宜久坐。" },
    { num: "慧仪签", text: "上上签：今日犯桃花，宜吃喝玩乐，不宜工作。" },
    { num: "波哥签", text: "上上签：福泽绵长，宜行善积德，不宜闷闷不乐。" },
    { num: "梦媛签", text: "上上签：桂花飘香满人间，金秋时节正当时。家宅兴旺多吉庆，财源滚滚福无边。" },
    ...
    { num: "蹚弟签", text: "上上签：新婚快乐，早生贵子，幸福美满。" },
